...
int main(){
	printf("\t\t====Find The Maximum Number That Can Build From Five Digits====\n");
	printf("\n\n\n\nInsert Five Digits To Get Started\n");
	int i=0;
...
printf("\n\tMaximum Number That Can Build From Given Digits Is %d" ,dequeue_Sorted());
